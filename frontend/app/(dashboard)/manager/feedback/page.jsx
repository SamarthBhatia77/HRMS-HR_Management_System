  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Team Feedback</h1>
        ...
        <div className="flex gap-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-3 rounded-2xl shadow-sm">
          <div className="px-3 border-r border-slate-100 dark:border-slate-800 text-center">
            <span className="text-[10px] uppercase font-bold text-slate-400 dark:text-slate-500">Total Feedbacks</span>
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-955 px-3 py-2 text-sm text-slate-950 dark:text-slate-100 focus:border-indigo-400 focus:outline-none"
            >
                ...
                <div>
                  ...
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="flex items-center gap-2.5">
                      <div className="h-9 w-9 rounded-xl bg-violet-50 dark:bg-violet-950/20 flex items-center justify-center text-lg flex-shrink-0 text-violet-600 dark:text-violet-400 border border-violet-100 dark:border-violet-900/30">
                        {cat.icon}
                      </div>
                      <div>
                    ...
                    {fb.anonymous ? (
                      ...
                      <span className="text-[9px] font-bold tracking-wider uppercase bg-violet-50 dark:bg-violet-950/30 text-violet-600 dark:text-violet-400 border border-violet-100 dark:border-violet-900/30 px-2 py-0.5 rounded-full">
                        {fb.employeeName}
                      </span>
                    )}
                  </div>
