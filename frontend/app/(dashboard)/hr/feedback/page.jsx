        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              className="w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-950 focus:border-brand-500 focus:outline-none"
            >
                ...
                <div>
                  ...
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="flex items-center gap-2.5">
                      <div className="h-9 w-9 rounded-xl bg-brand-50 flex items-center justify-center text-lg flex-shrink-0 text-brand-700 border border-brand-100">
                        {cat.icon}
                      </div>
                      <div>
                    ...
                    {fb.anonymous ? (
                      ...
                      <span className="text-[9px] font-bold tracking-wider uppercase bg-brand-50 text-brand-700 border border-brand-100 px-2 py-0.5 rounded-full">
                        {fb.employeeName}
                      </span>
                    )}
                  </div>
